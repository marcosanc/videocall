package com.example.planetmedia.videocall.Activity;
...
import com.example.planetmedia.videocall.BuildConfig;
import com.example.planetmedia.videocall.R;
import com.example.planetmedia.videocall.dialog.Dialog;
import com.example.planetmedia.videocall.util.CameraCapturerCompat;
...
public class VideoActivity extends AppCompatActivity {
        ...
        switch (item.getItemId()) {
            case R.id.speaker_menu_item:
                if (audioManager.isSpeakerphoneOn()) {
                    ...
                    item.setIcon(R.drawable.ic_action_phonelink);
                } else {
                    audioManager.setSpeakerphoneOn(true);
    ...
    private void intializeUI() {
        connectActionFab.setImageDrawable(ContextCompat.getDrawable(this,
                R.drawable.ic_action_videocall));
        ...
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (localVideoTrack != null) {
                    ...
                    int icon;
                    if (enable) {
                        icon = R.drawable.ic_action_video;
                        switchCameraActionFab.show();
                    } else {
                        icon = R.drawable.ic_action_video_off;
        ...
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (localAudioTrack != null) {
                    ...
                    int icon = enable ?
                            R.drawable.ic_action_mic : R.drawable.ic_action_mic_off;
